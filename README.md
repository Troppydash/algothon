...
To run, execute `python eval.py`. The submission file is `submission/main.py`.
...
# Folder structure:
1. experiments: Contain all experimentation (data analysis, algorithm, testing support, etc.). Very messy due to having tested many things in a short time frame, need clean up.

2. submission: Clean up submission.

<b> Presentation slides </b>: https://docs.google.com/presentation/d/1ixyjPK6EsJ1QzmgrVzqMNjk2pvLo8X0BFyfyqO82ANM/edit?usp=sharing
